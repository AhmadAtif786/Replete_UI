...
export const getDesignTokens = (mode: 'light' | 'dark') => {
  ...
  return {
    ...
    palette: {
      ...
      text: {
        primary: getColor('#F3F3F3', '#F1F1F3'),
      ...
      background: {
        default: getColor('black', '#1B2030'),
        paper: getColor('#000000', '#292E41'),
        surface: getColor('#777', '#ffffff'),
        surface2: getColor('#F9F9FB', '#ffffff'),
        header: getColor('black', '#ffffff'),
        disabled: getColor('#777', '#EBEBEF14'),
      },
      divider: getColor('rgba(235, 235, 239, 0.08)', '#EBEBEF14'),
      action: {
        active: getColor('#F3F3F3', '#EBEBEF8F'),
        hover: getColor('#F1F1F3', '#EBEBEF14'),
        selected: getColor('#EAEBEF', '#EBEBEF29'),
        disabled: getColor('#131313', '#EBEBEF4D'),
      ...
      gradients: {
        ...
        aaveGradient: 'linear-gradient(249deg, #000 10.51%, #FFF 93.41%)',
        ...
        variants: [
          {
            ...
            style: {
              ...
              border: '0.5px solid var(--Light-stroke, rgba(243, 243, 243, 0.80))',
              borderRadius:'20px',
